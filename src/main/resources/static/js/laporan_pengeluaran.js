...
function GenerateGrid(parameter) {
    $("#gridview").empty();
    $("#gridview").append("<div id='gvLaporanPengeluaran' style='width:100%;'></div>");

        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: get_uri() + "/api/pengeluaran/laporanpengeluaran/"+parameter.tglMasuk+"/"+parameter.tglKeluar,
        ...
        grid = $("#gvLaporanPengeluaran").kendoGrid({
