...
function GenerateGrid(parameter) {
    $("#gridview").empty();
    $("#gridview").append("<div id='gvLaporanPembelian' style='width:100%;'></div>");

        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: get_uri() + "/api/pembelian/laporanpembelian/"+parameter.tglMasuk+"/"+parameter.tglKeluar,
        ...
        grid = $("#gvLaporanPembelian").kendoGrid({
            ...
            columns: [{
                ...
                field: "pesanan.customer.nameCustomer",
                title: "Customer",
                filterable: false,
                width: 300
            },
            {
                            field: "pesanan.customer.alamat",
                            title: "Alamat",
                            filterable: false,
                            width: 300
                        },
                        {
                                                    field: "pesanan.customer.noHandphone",
                                                    title: "No Handphone",
                                                    filterable: false,
                                                    width: 100
                                                },
