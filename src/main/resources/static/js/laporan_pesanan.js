...
function GenerateGrid(parameter) {
    $("#gridview").empty();
    $("#gridview").append("<div id='gvLaporanPesanan' style='width:100%;'></div>");

        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: get_uri() + "/api/pesanan/laporanpesanan/"+parameter.tglMasuk+"/"+parameter.tglKeluar,
        ...
        grid = $("#gvLaporanPesanan").kendoGrid({
